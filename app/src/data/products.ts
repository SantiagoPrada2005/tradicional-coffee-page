...
export const exploreProducts: Product[] = [
    ...
    { id: 12, name: "Cappuccino con marshmallow", description: "Expresso, leche cremada, crema chantilly y marshmallow.", price: "$9.000", image: "/images/cappuccino-con-marshmallow.jpeg", alt: "Cappuccino con marshmallow", category: 'hot' },
    ...
    { id: 14, name: "Latte frío", description: "Expresso sencillo, leche y hielo.", price: "$8.000", image: "/images/latte-frio.jpeg", alt: "Latte frío", category: 'latte' },
    { id: 15, name: "Hielato", description: "Leche condensada, espresso y leche espumada.", price: "$8.000", image: "/images/hielato.jpeg", alt: "Hielato", category: 'cold' },
    ...
    { id: 22, name: "Chocolate marsmello", description: "Chocolate caliente con malvaviscos.", price: "$6.000", image: "/images/chocolatemars.jpeg", alt: "Chocolate con marshmallow", category: 'hot' },
    ...
    { id: 30, name: "Frappe de Mocca", description: "Mezcla de café y chocolate.", price: "$10.000", image: "/images/frappe-mocca.png", alt: "Frappe Mocca", category: 'frappe' },
